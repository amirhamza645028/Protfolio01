...
// import {imgbgfresh} from '../assets/bgfresh.png'
import img2 from '../assets/bgfresh.png'
const Navbar = () => {
    const navOptions = <>
        ...
        <div>
            <div className="body navbar  shadow-sm">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-xl">The hamza</a>
                </div>
                ...
                <div className="navbar-end">
                    <img className="rounded-full h-12 w-12" src={img2} alt="" />
